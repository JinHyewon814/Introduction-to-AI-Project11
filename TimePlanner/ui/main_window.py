...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.activate_date(self.data["date"])
        ...
        self.timetable1 = TimeTable(self, title="a.m 00:00-11:59")
        self.timetable2 = TimeTable(self, title="p.m 12:00-23:59")
    ...
    def activate_date(self, selected_date):
        self.data["date"] = selected_date
        if "days" not in self.data:
            self.data["days"] = {}

        day_data = self.data["days"].setdefault(selected_date, {"tasks": [], "blocks": []})
        self.data["tasks"] = day_data["tasks"]
        self.data["blocks"] = day_data["blocks"]

    def save_data(self):
        self.data["days"][self.data["date"]] = {
    ...
    def on_date_label_clicked(self, event):
        ...
        def on_date_selected():
            ...
            self.activate_date(selected_qdate.toPython().isoformat())
